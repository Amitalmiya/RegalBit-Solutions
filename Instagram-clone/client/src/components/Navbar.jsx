...
export default function Navbar() {
  ...
  const unreadCount = useSelector((s) => s.chat?.unreadCount || 0);
  ...
  // Fix: exact match for '/', startsWith for others
  const isActive = (path) => {
  ...
  const NavBtn = ({ to, title, children, badge }) => (
    ...
    >
      ...
      {badge > 0 && (
        <span
          className="absolute top-0 right-0 w-4 h-4 rounded-full flex items-center justify-center font-bold"
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          {/* ── Messages ── */}
          <NavBtn to="/messages" title="Messages" badge={unreadCount}>
            <svg
              className="w-5 h-5"
          ...
          <div className="relative ml-1">
            <button
              ...
              style={{
                background: menu ? 'rgba(147,51,234,0.15)' : 'transparent',
                border: 'none',
                cursor: 'pointer',
              }}
            >
              <img
                ...
                style={{
                  outline: isActive(`/profile/${user?.username}`)
                    ? '2px solid var(--accent-1)' : 'none',
                  outlineOffset: '2px',
                }}
              />
            </button>
            ...
            {menu && (
              <>
                ...
                />
                <div
                  className="absolute right-0 mt-2 w-56 glass rounded-2xl overflow-hidden animate-scale-in"
                  style={{
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-semibold"
                        style={{ color: 'var(--text-primary)' }}>{user?.username}</p>
